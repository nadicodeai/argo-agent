...
Trust levels:
  - builtin:   Ships with Argo. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.argo/\.env|\~/\.argo/\.env',
     "argo_env_access", "critical", "exfiltration",
     "directly references Argo secrets file"),
    ...
    (r'\.argo/config\.yaml|\.argo/SOUL\.md',
     "argo_config_mod", "critical", "persistence",
     "references Argo configuration files directly"),
