...
the get_anchored_view / get_messages_around primitives in argo_state.
...
# Third-party integrations tag their sessions with ARGO_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from argo_state import DEFAULT_DB_PATH
