...
def worker_loop(worker_id: int, argo_home: str, result_file: str) -> None:
...
def reclaimer_loop(argo_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="argo_mixed_stress_")
    print(f"ARGO_HOME = {home}")
