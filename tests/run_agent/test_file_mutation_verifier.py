...
class TestVerifierEnabled:
    def test_default_is_enabled(self, monkeypatch):
        monkeypatch.delenv("ARGO_FILE_MUTATION_VERIFIER", raising=False)
        agent = _bare_agent()
