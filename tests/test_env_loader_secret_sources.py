"""Tests for the secret-source tracking in ``argo_cli.env_loader``.

These cover the small public surface that lets `argo model` / `argo setup`
...
from argo_cli import env_loader  # noqa: E402
