...
def _enable_managed_nous_tools(monkeypatch):
    ...
    argo_cli.auth and argo_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("argo_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("argo_cli.models.check_nous_free_tier", lambda: False)
