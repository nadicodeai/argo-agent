...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from argo_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ARGO_OVERLAYS
        overlay = ARGO_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify argo doctor recognizes Xiaomi env vars."""
