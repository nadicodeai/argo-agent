...
The main() function in argo_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `argo -c model`
...
def _build_parser():
    """Build a minimal replica of the argo top-level parser."""
