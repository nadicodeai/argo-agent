"""Tests for the interactive session browser (`argo sessions browse`).
...
from argo_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """argo sessions browse should be parseable."""
        from argo_cli.main import main as _main_entry
