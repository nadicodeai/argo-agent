...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("argo_cli.config.get_config_path", return_value=config_path), \
             patch("argo_cli.config.ensure_argo_home"):
    ...
    def test_ensure_argo_home_sets_0700(self):
        home = Path(self.tmpdir) / ".argo"
        with patch("argo_cli.config.get_argo_home", return_value=home):
