...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "argo_approve_once" in action_ids
        assert "argo_approve_session" in action_ids
        assert "argo_approve_always" in action_ids
        assert "argo_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "argo_deny", "value": "session-key"}
