"""Tests for argo-api-server toolset and API server tool availability."""
import os
import json
...
class TestArgoApiServerToolset:
    """Tests for the argo-api-server toolset definition."""

    def test_toolset_exists(self):
        ts = get_toolset("argo-api-server")
        assert ts is not None

    def test_toolset_validates(self):
        assert validate_toolset("argo-api-server")

    def test_toolset_includes_web_tools(self):
        tools = resolve_toolset("argo-api-server")
...
class TestApiServerPlatformConfig:
    def test_platforms_dict_includes_api_server(self):
        ...
        assert PLATFORMS["api_server"]["default_toolset"] == "argo-api-server"
...
class TestApiServerAdapterToolset:
    ...
    def test_create_agent_reads_config_toolsets(self):
        ...
        with patch("gateway.run._resolve_runtime_agent_kwargs") as mock_kwargs, \
            ...
            # No platform_toolsets override — should fall back to argo-api-server default
