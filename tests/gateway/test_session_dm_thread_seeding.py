...
def store(tmp_path, monkeypatch):
    ...
    ~/.argo/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at argo_state import time, before pytest's ARGO_HOME monkeypatch
    fires — the autouse fixture's ARGO_HOME override doesn't help here.)
    """
    import argo_state
