...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("ARGO_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("ARGO_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    monkeypatch.delenv("ARGO_GATEWAY_BUSY_INPUT_MODE", raising=False)
    monkeypatch.delenv("ARGO_RESTART_DRAIN_TIMEOUT", raising=False)
    monkeypatch.delenv("ARGO_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
