...
Used by ``argo profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``argo_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Argo Agent kanban board.
...
Rules:
  ...
  - Never write "Argo Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_argo_home())
        else:
