"""
Skills configuration for Argo Agent.
`argo skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.argo/config.yaml under:
...
from argo_cli.config import cfg_get, load_config, save_config
from argo_cli.colors import Colors, color
from argo_cli.platforms import PLATFORMS as _PLATFORMS
