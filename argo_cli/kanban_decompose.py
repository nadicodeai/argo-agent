...
Invoked by ``argo kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Argo Agent board.
...
def _profile_author() -> str:
    """Mirror of ``argo_cli.kanban._profile_author``."""
    return (
