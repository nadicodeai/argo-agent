...
def _update_via_zip(args):
    ...
    branch = "main"
    zip_url = (
        f"https://github.com/nadicodeai/argo-agent/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/nadicodeai/argo-agent.git",
    "git@github.com:nadicodeai/argo-agent.git",
    "https://github.com/nadicodeai/argo-agent",
    "git@github.com:nadicodeai/argo-agent",
}
OFFICIAL_REPO_URL = "https://github.com/nadicodeai/argo-agent.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from nadicodeai/argo-agent.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/nadicodeai/argo-agent.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/nadicodeai/argo-agent.git' to add later."
            )
