#!/usr/bin/env python3
"""Build the Argo Skills Index — a centralized JSON catalog of all skills.
...
`argo skills search/install` can use it without hitting the GitHub API.
...
# Ensure ARGO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Argo Skills Index...", flush=True)
