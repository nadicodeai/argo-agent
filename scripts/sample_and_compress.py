...
DEFAULT_DATASETS = [
    ...
    "NousResearch/argo-agent-megascience-sft1",
    "NousResearch/Argo-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Argo-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-argo-agent"
]
