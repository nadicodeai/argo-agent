...
projection into Argo' display, approval bridging, transcript projection into
...
"codex_app_server"`. Argo' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("ARGO_KANBAN_TASK"):
            kanban_db = spawn_env.get("ARGO_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "ARGO_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("ARGO_HOME", os.path.expanduser("~/.argo")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "argo",
        client_title: str = "Argo Agent",
