...
```bash
python3 -m pyfiglet "ARGO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ARGO&font=Slant" | boxes -d stone
```
