...
```python
import sys
sys.path.insert(0, "/home/teknium/.argo/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.argo/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Argo installs package this)
