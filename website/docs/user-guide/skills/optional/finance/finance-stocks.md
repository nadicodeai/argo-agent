...
| | |
|---|---|
| Source | Optional — install with `argo skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Argo Agent |
| License | MIT |
...
```
SCRIPT=~/.argo/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.argo/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
