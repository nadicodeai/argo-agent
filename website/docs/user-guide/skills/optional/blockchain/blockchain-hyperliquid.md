...
| | |
|---|---|
| Source | Optional — install with `argo skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Argo Agent |
| License | MIT |
...
The script reads `~/.argo/.env` for two optional defaults:
...
Helper script: `~/.argo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.argo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.argo/.env`.
...
```bash
python3 ~/.argo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.argo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
