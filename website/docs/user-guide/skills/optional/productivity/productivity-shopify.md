...
| | |
|---|---|
| Source | Optional — install with `argo skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Argo","productType":"Apparel","tags":["test"]}}'
```
