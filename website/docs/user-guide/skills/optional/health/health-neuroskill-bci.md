...
| | |
|---|---|
| Source | Optional — install with `argo skills install official/health/neuroskill-bci` |
...
Connect Argo to a running [NeuroSkill](https://neuroskill.com/) instance to read
