...
| | |
|---|---|
| Source | Optional — install with `argo skills install official/web-development/page-agent` |
...
- User wants **Argo itself to drive a browser** → use Argo' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
