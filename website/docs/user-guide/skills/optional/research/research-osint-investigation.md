...
| | |
|---|---|
| Source | Optional — install with `argo skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Argo Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ARGO_OSINT_CACHE/icij/ (default: ~/.cache/argo-osint/icij/).
...
# Set ARGO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
