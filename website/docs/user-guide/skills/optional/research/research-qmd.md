...
| | |
|---|---|
| Source | Optional — install with `argo skills install official/research/qmd` |
...
Argo Agent via the native MCP client. This is the preferred
...
Then configure Argo Agent to connect via HTTP:
