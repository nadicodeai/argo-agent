...
If you find a bug, [open an issue](https://github.com/NousResearch/hermes-agent/issues) with the output of `argo logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
