#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Argo docs site.
...
Both publish at:
  https://argo-agent.nousresearch.com/docs/llms.txt
  https://argo-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://argo-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Argo as a Python Library", None),
        ("guides/use-mcp-with-argo", "Use MCP with Argo", None),
        ("guides/use-voice-mode-with-argo", "Use Voice Mode with Argo", None),
        ("guides/use-soul-with-argo", "Use SOUL.md with Argo", None),
        ("guides/build-a-argo-plugin", "Build a Argo Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Argo"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "argo-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/argo-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Argo Agent — Full Documentation\n",
        (
            "This file is the entire Argo Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Argo, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://argo-agent.nousresearch.com/docs\n",
        "Short index: https://argo-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
