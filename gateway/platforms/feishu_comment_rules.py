...
Config: ~/.argo/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.argo/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_argo_home()`` helper (ARGO_HOME-aware and
...
RULES_FILE = get_argo_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_argo_home() / "feishu_comment_pairing.json"
