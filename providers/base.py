...
def _profile_user_agent() -> str:
    """Return a ``argo-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from argo_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"argo-cli/{_ver}"
    except Exception:
        return "argo-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # argo-cli UA so the catalog endpoint is reachable.
