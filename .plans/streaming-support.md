# Streaming LLM Response Support for Argo Agent
...
```
ARGO_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ARGO_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `argo_cli/config.py` | 1 | +streaming config defaults |
