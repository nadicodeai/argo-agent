...
- Removed `/model` slash command from CLI and gateway in favor of `argo model` subcommand ([#3080](https://github.com/NousResearch/hermes-agent/pull/3080))
...
- Fix plugin toolsets invisible in `argo tools` and standalone processes ([#3457](https://github.com/NousResearch/hermes-agent/pull/3457))
- Consolidate `get_argo_home()` and `parse_reasoning_effort()` ([#3062](https://github.com/NousResearch/hermes-agent/pull/3062))
- Remove unused Argo-native PKCE OAuth flow ([#3107](https://github.com/NousResearch/hermes-agent/pull/3107))
...
- Stop loading argo repo AGENTS.md into gateway sessions (~10k wasted tokens) ([#2891](https://github.com/NousResearch/hermes-agent/pull/2891))
...
- Harden `argo update` against diverged history, non-main branches, and gateway edge cases ([#3492](https://github.com/NousResearch/hermes-agent/pull/3492))
...
- Add explicit `argo-api-server` toolset for API server platform ([#3304](https://github.com/NousResearch/hermes-agent/pull/3304))
...
- **OpenClaw migration v2** — 17 new modules, terminal recap for migrating from OpenClaw to Argo ([#2906](https://github.com/NousResearch/hermes-agent/pull/2906))
...
- Fix `argo update` PEP 668 "externally-managed-environment" error ([#3099](https://github.com/NousResearch/hermes-agent/pull/3099))
