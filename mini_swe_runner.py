#!/usr/bin/env python3
"""
SWE Runner with Argo Trajectory Format

A runner that uses Argo-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Argo-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Argo-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Argo format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Argo-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Argo-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Argo Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Argo-Agent's built-in execution environments
    and outputs trajectories in Argo-Agent format.
    """
    ...
    def _convert_to_argo_format(
        ...
        """
        Convert internal message format to Argo trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Argo trajectory format
        trajectory = self._convert_to_argo_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Argo trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Argo Trajectory Format")
    print("=" * 60)
