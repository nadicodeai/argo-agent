...
``_check_spotify_available()`` — when the user has not run ``argo auth
spotify``, the tools remain registered (so they appear in ``argo
...
The Spotify auth flow (``argo auth spotify``), CLI plumbing, and docs
