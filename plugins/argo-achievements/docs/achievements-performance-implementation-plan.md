# Argo Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.argo/plugins/argo-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.argo/plugins/argo-achievements/scan_checkpoint.json`.
