...
- **MCP server management CLI** — `argo mcp` commands for installing, configuring, and authenticating MCP servers with full OAuth 2.1 PKCE flow ([#2465](https://github.com/NousResearch/hermes-agent/pull/2465))
...
- Fix: show human-readable error when `argo setup` hits permissions error ([#2196](https://github.com/NousResearch/hermes-agent/pull/2196))
...
- Fix: disabled toolsets re-enable themselves after `argo tools` ([#2268](https://github.com/NousResearch/hermes-agent/pull/2268))
...
- Fix: `argo update` use `.[all]` extras with fallback ([#1728](https://github.com/NousResearch/hermes-agent/pull/1728))
- Fix: `argo update` prompt before resetting working tree on stash conflicts ([#2390](https://github.com/NousResearch/hermes-agent/pull/2390))
...
- **Auto session titles** and `.argo.md` project config ([#1712](https://github.com/NousResearch/hermes-agent/pull/1712))
...
- **Interactive MCP tool configuration** in `argo tools` ([#1694](https://github.com/NousResearch/hermes-agent/pull/1694))
...
- **Argo-agent-setup** skill ([#1905](https://github.com/NousResearch/hermes-agent/pull/1905))

---

## 🔌 Plugin System Enhancements

- **TUI extension hooks** — Build custom CLIs on top of Argo ([#2333](https://github.com/NousResearch/hermes-agent/pull/2333))
- **`argo plugins install/remove/list`** commands ([#2337](https://github.com/NousResearch/hermes-agent/pull/2337))
...
- Align Argo setup and full-suite expectations ([#1710](https://github.com/NousResearch/hermes-agent/pull/1710))
