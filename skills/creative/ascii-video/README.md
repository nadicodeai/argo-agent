...
Built for [Argo Agent](https://github.com/nadicodeai/argo-agent). Usable in any coding agent. Canonical source lives here; synced to [`nadicodeai/argo-agent/skills/creative/ascii-video`](https://github.com/nadicodeai/argo-agent/tree/main/skills/creative/ascii-video) via PR.
