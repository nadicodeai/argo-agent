...
Built for [Argo Agent](https://github.com/NousResearch/argo-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/argo-agent/skills/creative/ascii-video`](https://github.com/NousResearch/argo-agent/tree/main/skills/creative/ascii-video) via PR.
