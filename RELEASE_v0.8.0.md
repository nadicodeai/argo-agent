...
- **Centralized Logging & Config Validation** — Structured logging to `~/.argo/logs/` (agent.log + errors.log) with the `argo logs` command for tailing and filtering. Config structure validation catches malformed YAML at startup before it causes cryptic failures. ([#5430](https://github.com/NousResearch/hermes-agent/pull/5430), [#5426](https://github.com/NousResearch/hermes-agent/pull/5426))
...
- **Non-agentic model warning** — warns users when loading Argo LLM models not designed for tool use ([#5378](https://github.com/NousResearch/hermes-agent/pull/5378))
...
- **ARGO_PORTAL_BASE_URL env var** respected during Nous login — @benbarclay ([#5745](https://github.com/NousResearch/hermes-agent/pull/5745))
...
- **Stale 'argo login' replaced** with 'argo auth' + credential removal re-seeding fix ([#5670](https://github.com/NousResearch/hermes-agent/pull/5670))
...
- **Centralized logging** to `~/.argo/logs/` — agent.log (INFO+), errors.log (WARNING+) with `argo logs` command ([#5430](https://github.com/NousResearch/hermes-agent/pull/5430))
...
- **`argo auth remove`** now clears env-seeded credentials permanently ([#5285](https://github.com/NousResearch/hermes-agent/pull/5285))
- **Bundled skills synced to all profiles** during update ([#5795](https://github.com/NousResearch/hermes-agent/pull/5795))
- **`argo update` no longer kills** freshly-restarted gateway service ([#5448](https://github.com/NousResearch/hermes-agent/pull/5448))
...
- **Nix flake** — read version, regen uv.lock, add argo_logging — @alt-glitch ([#5651](https://github.com/NousResearch/hermes-agent/pull/5651))
...
- **Argo Mod visual skin editor** added to skins page ([#6095](https://github.com/NousResearch/hermes-agent/pull/6095))
