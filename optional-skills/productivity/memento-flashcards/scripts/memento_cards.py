...
Data file: $ARGO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ARGO_HOME = Path(os.environ.get("ARGO_HOME", Path.home() / ".argo"))
DATA_DIR = _ARGO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
