...
import type { ScrollBoxHandle } from '@argo/ink'
import { evictInkCaches } from '@argo/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ARGO_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
