...
const STORAGE_KEY = "argo-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `argo_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "argo-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-argo-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-argo-theme-font", "true");
