 ...
 * `window.__ARGO_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Argo brand in the top bar
 ...
 *  `window.__ARGO_PLUGINS__.registerSlot(...)`.
 *
